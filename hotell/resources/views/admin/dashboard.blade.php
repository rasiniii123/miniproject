                                    ...
                                    <div class="card">
                                        <div class="d-flex align-items-end row">
                                            ...
                                            <div class="col-4 pt-3 ps-0">
                                                <img src="../../assets/img/illustrations/prize-light.png" width="90"
                                                ...
                                                <div class="card-body">
                                                    <div class="report-list">
                                                        ...
                                                        <div class="report-list-item rounded-2 mb-3">
                                                            <div class="d-flex align-items-start">
                                                                <div class="report-list-icon shadow-sm me-2">
                                                                    <img src="https://demos.themeselection.com/sneat-bootstrap-html-admin-template/assets/svg/icons/shopping-bag-icon.svg"
                                                                        width="22" height="22"
                                                                        alt="Shopping Bag">
                                                                </div>
                                                                <div
                                            ...
                                            <ul class="p-0 m-0">
                                                ...
                                                <li class="d-flex mb-4">
                                                    <div class="d-flex w-100 flex-wrap justify-content-between gap-2">
                                                        ...
                                                        <div class="user-progress">
                                                            <i class='bx bx-down-arrow-alt text-danger me-2'></i> <span>-
                                                                8.5% </span>
                                                        </div>
                                                    </div>
                                                </li>
                                            ...
                                            <table class="table text-nowrap">
                                                ...
                                                <tbody class="table-border-bottom-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="lh-1"><span
                                                                    class="text-primary fw-medium">$149</span></div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="../../assets/img/products/iphone.png"
                                                                    alt="Apple" height="32" width="32"
                                                                    class="me-2">
                                                                <div class="d-flex flex-column">
                                                        ...
                                                        <td>
                                                            <div class="lh-1"><span
                                                                    class="text-primary fw-medium">$399</span></div>
                                                            <small class="text-muted">Fully Paid</small>
                                                        </td>
                                                        <td><span class="badge bg-label-success">Completed</span></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <img src="../../assets/img/products/mi-tv.png"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="lh-1"><span
                                                                    class="text-primary fw-medium">$89</span></div>
                                                            <small class="text-muted">Fully Paid</small>
                                                        </td>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <small class="text-muted">You have done <span
                                                        class="fw-medium">57.6%</span> more sales.<br>Check your new badge
