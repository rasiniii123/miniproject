            ...
            <div class="col-md-12 " style="margin-top: 50px;">
                <div class="hotel" id="room_id{{ $room->id }}" >
                    ...
                    <div class="menu-item" style="display: flex; flex-direction: column; align-items: flex-start;">
                        <div style="color: black; font-size: 30px; font-family: Poppins; font-weight: 600; line-height: 36px; letter-spacing: 0.20px; word-wrap: break-word; text-align: right; margin-left: 300px; margin-top:-50;">
                            {{ $room->nama_kamar }}
                        </div>
                        <!-- Pindahkan gambar di sini -->
                        <img src="{{ asset('storage/kamar/'.$room->path_kamar) }}" style="width: 700px; height:300px;  margin-bottom: 20px; margin-left: 80px; margin-top:20px;">
                        <!-- Tambahkan deskripsi dan informasi lainnya -->
                        <div style="margin-left: 100px; font-family: Poppins; width: 750px; word-wrap: break-word; overflow-x: auto;">
                            <div style="display: flex; align-items: center; margin-top: 20px;">
                                <img src="/images/uang.png" alt="Gambar Baru" style="max-width: 20px; max-height: 20px; margin-right: 5px;">
                                <div class="harga" style="font-family: Poppins; font-size: 18px; margin-left:10px;">Rp {{ number_format($room->harga, 0, ',', '.') }} <span style="color: #D88F00;">/Malam</span></div>
                            </div>
                            <div style="margin-top: 20px;"></div> <!-- Jarak tambahan -->
                            <div style="margin-top: 20px; display: flex; justify-content: flex-end;">
                                <a href="{{ route('detail.index', ['id' => $room->id]) }}" class="btn btn-primary float-end" style="background-color: #283E58; display: inline-block; margin-right: 580px;">PESAN SEKARANG</a>
                            </div>
